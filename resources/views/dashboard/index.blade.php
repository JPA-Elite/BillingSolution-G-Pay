		...
		<div class="nav-header">
			<a href="/gpay.com/dashboard/" class="brand-logo">
				...
				<div style="text-align: center;">
					...
					<p style="color:black;font-size: 12px;">Invoice & Billings</p>
				</div>
		...
		<div class="deznav">
			<div class="deznav-scroll">
				<div class="main-profile">
					...
					<h5 class="name"><span class="font-w400">Hello,</span> <?php echo $_COOKIE["f_name"] ?></h5>
					<p class="email"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="95f8f4e7e4e0f0efefefefd5f8f4fcf9bbf6faf8"> <?php echo $_COOKIE["email"] ?></a></p>
				</div>
				<ul class="metismenu" id="menu">
					...
					<li><a href="user-list-datatable.html"><i class="flaticon-144-layout"></i><span class="nav-text">Users</span></a></li>

					<li><a href="project-list.html"><i class="flaticon-144-layout"></i><span class="nav-text">Projects</span></a></li>
					<li><a href="tranasactions.html"><i class="flaticon-144-layout"></i><span class="nav-text">Transactions</span></a></li>


					<li><a href="coin-details.html"><i class="flaticon-144-layout"></i><span class="nav-text">Suggestions & Concerns</span></a></li>

					<li><a href="market-capital.html"><i class="flaticon-144-layout"></i><span class="nav-text">Billing
								Analysis</span></a></li>
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">Proponents</span>
						</a>
						<ul aria-expanded="false">
							<li><a href="app-profile.html">Login Page</a></li>
							<li><a href="post-details.html">Signup Page</a></li>
				...
				<div class="copyright">
					<p style="color:white"> <strong>G-Pay Admin Dashboard</strong> © 2021 All Rights Reserved</p>
		...
		<div class="content-body">
			<div class="container-fluid">
				<div class="form-head mb-sm-5 mb-3 d-flex flex-wrap align-items-center">
					...
					<div class="weather-btn mb-2 d-flex justify-content-between align-items-center" style="
