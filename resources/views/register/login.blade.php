...
<body class="body">
      ...
      <form class="form-control login-form p-5" action="/gpay.com/register/login" method="post" name="registration">
        ...
        <div class="mb-3">
          <div class="d-flex justify-content-between align-items-end p-1">
            ...
            <a for="forgot-pass" class="fs-7" href="/gpay.com/register/forgot-password">Forgot password<svg class="ms-1 mb-1" width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="d-flex form-control p-0 pe-1 justify-content-between">
            ...
            <svg class="eye-pass cursor-pointer" width="24" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <script>
    ...
    const eye_pass = document.querySelector('.eye-pass');
